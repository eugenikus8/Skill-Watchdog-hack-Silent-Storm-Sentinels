...
И еще, значения поснастроены под определенные значения стартовых характеристик. Если хотите изменить, смотрите таблицу и подганяйте значения icp в скрипте под свои нужды.

...
Skill Watchdog — это хак, а не патч или чит.
Что нового:
...
=====================================
ПРИМЕЧАНИЕ eugenikus8 по Часовым.
Автопрокачка навыков примерно на 10-25% ниже для текущего уровня персонажа, чем дает чит-команда консоли setxplevel.
...
И еще, значения настроены под определенные значения стартовых характеристик с которыми я играл.
Если вы устанавливаете другие характеристики у ГГ (сила, ловкость, интеллект), то смотрите excel таблицу и подганяйте значения icp в скрипте под свои нужды.

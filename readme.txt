...
На 28 уровне персонажа это на 1-9 уровней навыка ниже максимума.
И еще, значения настроены под определенные значения стартовых характеристик. Если хотите изменить, смотрите excel таблицу и подганяйте значения icp в скрипте под свои нужды.
